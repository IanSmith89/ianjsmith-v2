			...
			return knex('projects')
				.insert([
					...
					},
					{
						...
						design_process: [
							'I began this project by digesting the research my colleague had completed. By familiarizing with the context I was able to understand where to go next. We identified the tasks the company completed on a daily basis to inform our decisions for the information architecture. Working closely with a colleague, I completed some initial sketches and whiteboarding sessions to help flesh out our ideas.',
							'Since the company lacked organization of their information I created a sitemap to guide the process. This allowed our team to decide how to structure the system moving forward.',
							'Next, I created workflow diagrams to map out how the tasks coincided with each other. By focusing on the essential tasks of the company we established workflow patterns to put in place for similar tasks.',
							'The most common tasks were generating records for inventory items and updating their location within their lab. Other tasks included tracking online orders, donors, and product details. After defining all common tasks, we had a good idea of the functionality and relationships of the entire system. Using this knowledge we moved on to wireframes and visual mockups.',
							'Knowing the location of inventory items in the lab was essential to their staff, and updating product status and location were vital repeated tasks. Using their lab equipment as inspiration, we based the interface on the racks that contained the vials within freezers in their lab. After a few iterations, we decided on a color-coded system to show the product groupings and location. That way the staff could view their inventory on screen in the same orientation within the racks in the freezers.',
							"The reaction to our ideas was positive from the staff. They could find and update a product's location and trust what the interface displayed. With the essential tasks considered and defined we moved forward with visual design. I decided to apply a flat aesthetic with a color palette that fit the brand and e-commerce site. Familiar interface components allowed the staff to migrate away from spreadsheets and paper notes without new patterns overwhelming them."
						],
						outcome_and_reflection: [
					...
					},
					{
						...
						design_process: [
							'We began with a heuristic review and surveys to understand how current users felt about the site. The heuristic review highlighted areas of improvement and positive aspects such as the strength of the existing content and a starting point for the visual identity.',
							'Information gathered from our user surveys reinforced the need for the features MightyVet asked for. Users needed online mentorship opportunities and options for continuing education credits. We also completed competitive analyses to identify how similar nonprofits presented their goals and composed their sites. From there we were able to start implementing new ideas.',
